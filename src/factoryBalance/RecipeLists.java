...
public class RecipeLists {
	...
	*/
	...
	public static String[][][] RecipeList(){
		...
		//		Science				Inserters					Electronics				Oil/Liquids
		Small[1][0][0]="SPB";/**/Small[2][0][0]="IF1";/**/Small[3][0][0]="EB3";/**/Small[4][0][0]="OB1";/**/
		Small[1][0][1]="2 3";/**/Small[2][0][1]="2 4";/**/Small[3][0][1]="2 5";/**/Small[4][0][1]="0 6";/**/
		/*                 *//**//*                 *//**//*                 *//**/Small[4][1][0]="OP"; /**/
		/*                 *//**//*                 *//**//*                 *//**/Small[4][1][1]="2 6";/**/
